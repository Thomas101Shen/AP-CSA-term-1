...
class Lesson_32_Activity_Four {
        ...
        {
        int hours = (num/3600);
  int minutes = (num%3600)/60;  //num%3600 gives amt of seconds not accounted for by hours
  int seconds = /*(num%3600)*/ num%60;  //last %60 gives amt of seconds not accounted for by min
